...
module GetTextFromHiddenElements
  module CommonComponents
    DEMO_PAGE = <<-eos.freeze
		...
		eos
    EXPECTED_INNERHTML = 'Demo div <p style="display:none">with a hidden paragraph inside.</p><hr><br>'.freeze
    EXPECTED_TEXTCONTENT = 'Demo div with a hidden paragraph inside.'.freeze
